...
if args.edge_id==5:
    ...
    sock_node_9.connect(('localhost', 52390))
    sock_node_10=socket.socket()
    sock_node_10.connect(('localhost', 52393))
...
if args.edge_id==6:
    ...
    sock_node_11.connect(('localhost', 52390))
    sock_node_12=socket.socket()
    sock_node_12.connect(('localhost', 52394))
...
if args.edge_id==7:
    ...
    sock_node_13.connect(('localhost', 52390))
    sock_node_14=socket.socket()
    sock_node_14.connect(('localhost', 52395))
...
if args.edge_id==8:
    ...
    sock_node_15.connect(('localhost', 52390))
    sock_node_16=socket.socket()
    sock_node_16.connect(('localhost', 52396))
...
if args.edge_id==9:
    ...
    sock_node_18.connect(('localhost', 52390))
    sock_node_19=socket.socket()
    sock_node_19.connect(('localhost', 52397))
...
if args.edge_id==10:
    ...
    sock_node_20.connect(('localhost', 52390))
    sock_node_21=socket.socket()
    sock_node_21.connect(('localhost', 52398))
    sock_node_22=socket.socket()
    sock_node_22.connect(('localhost', 52399))
...
if args.edge_id!=0:
    ...
    trainset = datasets.ImageFolder('/data/pcqu/Dataset/Dataset/cifar10/device_10_noniid_rate_05/device'+str(edge_num)+'/', transform=transform)
...
'''
    ...
    if epoch<10 or epoch>=40:
        ...
        if args.edge_id==7:
            ...
            des_model=add_model(rec_model_36,left_model)
        ...
        if args.edge_id==8:
            ...
            des_model=add_model(rec_model_38,left_model)
...
for i in range(200):
    if args.edge_id==0: 
        ...
        local_train(i)
        test(models, testloader, "test1040", i)