...
def printer(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/result1.txt"
...
def printer1(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node1_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer2(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node2_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()
...
def printer3(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node3_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()
...
def printer4(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node4_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer5(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node5_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer6(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node6_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()
...
def printer7(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node7_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer8(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node8_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer9(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node9_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()

def printer10(content):
    print(content)
    fid = "/data/pcqu/paper/result_reocrd/node10_result.txt"
    with open(fid,'a') as fid:
        content = content.rstrip('\n') + '\n'
        fid.write(content)
        fid.flush()
