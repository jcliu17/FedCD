...
listening_sock.bind(('localhost', 54490+args.edge_id))
...
if args.edge_id==1:
    ...
    sock_node_1.connect(('localhost', 54490))
...
if args.edge_id==2:
    ...
    sock_node_2.connect(('localhost', 54490))

if args.edge_id==3:
    sock_node_4=socket.socket()
    sock_node_4.connect(('localhost', 54491))

if args.edge_id==4:
    sock_node_5=socket.socket()
    sock_node_5.connect(('localhost', 54491))
...
testset = datasets.CIFAR100('/data/pcqu/Dataset/cifar-100-python', transform = transform)
...
def local_train(models):
    ...
    if args.edge_id==1:
        ...
        msg24=recv_msg(device_sock_all_2[0],"4_to_3")
        rec_model_12=msg24[1]
        msg25=recv_msg(device_sock_all_2[1],"5_to_3")
