...
listening_sock.bind(('localhost', 51120+args.edge_id))
...
if args.edge_id==1:
    ...
    sock_node_3.connect(('localhost', 51120))
...
if args.edge_id==2:
    ...
    sock_node_4.connect(('localhost', 51120))
    
    sock_node_1=socket.socket()
    sock_node_1.connect(('localhost', 51121))
...
if args.edge_id==3:
    ...
    sock_node_5.connect(('localhost', 51120))
    sock_node_2=socket.socket()
    sock_node_2.connect(('localhost', 51121))
...
if args.edge_id==4:
    ...
    sock_node_6.connect(('localhost', 51120))
    sock_node_7=socket.socket()
    sock_node_7.connect(('localhost', 51122))
    sock_node_8=socket.socket()
    sock_node_8.connect(('localhost', 51123))

if args.edge_id==5:
    sock_node_9=socket.socket()
    sock_node_9.connect(('localhost', 51120))
    sock_node_10=socket.socket()
    sock_node_10.connect(('localhost', 51122))
