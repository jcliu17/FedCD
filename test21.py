...
if args.edge_id==1:
    ...
    sock_node_1.connect(('localhost', 54460))


if args.edge_id==2:
    sock_node_2=socket.socket()
    sock_node_2.connect(('localhost', 54460))

if args.edge_id==3:
    sock_node_3=socket.socket()
    sock_node_3.connect(('localhost', 54460))

if args.edge_id==4:
    sock_node_4=socket.socket()
    sock_node_4.connect(('localhost', 54460))
...
def parameterserver():
    if args.edge_id==0:  
        ...
        msg12=recv_msg(device_sock_all_1[6],"2_to_0")
        msg13=recv_msg(device_sock_all_1[7],"2_to_0")
