...
if args.edge_id!=0:
    ...
    trainset = datasets.ImageFolder('/data/pcqu/Dataset/Dataset/cifar10/device_4_03/device'+str(edge_num)+'/', transform=transform)
...
def local_train():
    ...
    if args.edge_id==1:
        ...
        rec_model_50=scale_model(rec_model_50,-1)
        final_model=add_model(rec_model_60,rec_model_50)
        n=0
