...
if args.edge_id==0:
    while len(device_sock_all_2) < 8:
        print("Waiting for incoming connections...")
        listening_sock.listen(8)
...
if args.edge_id==5:
    ...
    sock_node_10.connect(('localhost', 54483))
...
if args.edge_id==6:
    ...
    sock_node_11.connect(('localhost', 54480))
    sock_node_12=socket.socket()
    sock_node_12.connect(('localhost', 54484))
...
if args.edge_id==7:
    ...
    sock_node_13.connect(('localhost', 54480))
    sock_node_14=socket.socket()
    sock_node_14.connect(('localhost', 54485))
...
if args.edge_id==8:
    ...
    sock_node_15.connect(('localhost', 54480))
    sock_node_16=socket.socket()
    sock_node_16.connect(('localhost', 54486))
    sock_node_17=socket.socket()
    sock_node_17.connect(('localhost', 54487))
...
def parameterserver():
    if args.edge_id==0:  
        ...
        des_model=scale_model(des_model,1.0/8)
